...
export const SEDES = ["Villa", "Norte", "Aramburú", "Ate"];
...
export const ADD_EMPTY = { nombre: "", facultad: "Ciencias de la Ingenieria", curso: "", bio: "", sede: "Villa", ...FORM_EMPTY, incluirResena: true };
